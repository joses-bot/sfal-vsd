...
# via master rules
# PG patterns
create_pg_mesh_pattern pg_mesh1 -layers {{{vertical_layer: met4} {width: @w1} {spacing: interleaving}  {pitch: @p1} {offset: @f} {trim: @t}}  {{horizontal_layer: met3} {width: @w2} {spacing: interleaving}  {pitch: @p2} {offset: @f} {trim: @t}}} -parameters {w1 p1 w2 p2 f t} 
create_pg_ring_pattern ring_pattern -horizontal_width {5} -vertical_width {5} -horizontal_layer {met3} -vertical_layer {met4} -horizontal_spacing {2} -vertical_spacing {2} -corner_bridge false 
